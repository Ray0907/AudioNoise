...
effects = flanger echo fm phaser discont ts9
...
ts9_defaults = 0.5 0.5 0.6 0

HEADERS = biquad.h  discont.h  echo.h  effect.h  flanger.h  fm.h  gensin.h lfo.h  phaser.h  ts9.h  util.h
